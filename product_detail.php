...
$stmt->execute();
$result = $stmt->fetch(PDO::FETCH_ASSOC); //[0]ခံစရာမလို။
			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
						...
						<div class="single-prd-item">
							<img class="img-fluid" src="admin/images/<?php echo $result['image']; ?>" width="400" alt="">
						</div>
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<form action="addtocart.php" method="post">
							...
							<input type="hidden" name="id" id="" value="<?php echo escape($result['id']); ?>">
